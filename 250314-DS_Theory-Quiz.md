#### 1. 인공지능에 대한 설명으로 옳지 않은 것을 고르세요. 3번
...
#### 6. 배열 a,b를 합쳐서 배열 c를 만드는 코드로 알맞은 것을 고르세요. 4번
...
#### 7. Pandas 라이브러리에 대한 설명으로 옳지 않은 것을 고르세요. 2번
...
#### 8. 결과 창과 동일하게 출력하기 위해 물음표에 들어가야 할 코드를 고르세요. 2번
...
#### 11. Seaborn 라이브러리에 대한 설명으로 옳지 않은 것을 고르세요. 3번
...
#### 18. 이상치에 대한 설명으로 옳지 않은 것을 고르세요. 4번
...
#### 21. 탐색적 데이터 분석 과정에서 옳지 않은 설명을 고르세요. 2번
